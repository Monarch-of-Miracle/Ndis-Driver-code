...
#define FILTER_FRIENDLY_NAME        L"Ndis6Firewall NDIS LightWeight Filter"
#define FILTER_UNIQUE_NAME          L"{99504a62-7cd2-4fd7-8d90-00a65b2222f5}" //unique name, quid name
#define FILTER_SERVICE_NAME         L"Ndis6Firewall"

//
// The filter needs to handle IOCTLs
//
#define LINKNAME_STRING             L"\\DosDevices\\Ndis6Firewall"
#define NTDEVICE_STRING             L"\\Device\\Ndis6Firewall"
...
DRIVER_DISPATCH Ndis6FirewallDispatch;

DRIVER_DISPATCH Ndis6FirewallDeviceIoControl;
